...
shinyUI(pageWithSidebar(
    ...
    sidebarPanel(
        ...
        selectInput("state2", "STATE",
                    ...
                    multiple = FALSE),
        splitLayout(
            checkboxInput("countyfiles","County",value = FALSE),
            checkboxInput("allfiles","All Files",value = FALSE)
        ),
        numericInput("xyear", "YEAR", 2024, max = 2024),
        # selectInput("xyear", "YEAR",
        #             choices = c("2020","2022"),
        #             selected = "2022",
        #             multiple = FALSE),
        selectInput("xelection", "ELECTION",
                    choices =  "20241105__mi__general",
                    selected = "20241105__mi__general",
                    multiple = FALSE),
        ...
        selectInput("units", "Units",
                    choices = c("Count","Count % shift","Count % drop","Percent","Percent ratio"),
                    selected = "Percent",
                    multiple = FALSE),
        ...
        tabsetPanel(id = "tabs", selected = "Areas",
            ...
            tabPanel("Area Plot",
                sidebarPanel(
                    ...
                    selectInput("label1", "Label type",
                                choices = c("Index","Index-County","Index-County-Area","County","CountyID","Area","CNTYVTD"),
                                selected = "Index",
                                multiple = FALSE),
            ...
            tabPanel("Area Plot2",
                     sidebarPanel(
                         ...
                         checkboxInput("areauc2","Area uppercase",value = FALSE),
