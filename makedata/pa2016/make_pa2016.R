...
url <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2016_General_PrecinctReturns.txt"
datapath <- "data/"
makepath <- "makedata/pa2016/"
makepath_pre <- paste0(makepath,"PA16_") #add file prefix
filename <- "20161108__pa__GE__precinct.csv"
#END PARAMETERS
...
# https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2016_General_ReadMeFile.txt
