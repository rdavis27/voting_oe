...
vrdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/VoterRegistration_2016_General_ReadMeFile.txt"
vrdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/VoterRegistration_2016_General_Precinct.xlsx"
erdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2016_General_ReadMeFile.txt"
erdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2016_General_PrecinctReturns.txt"
state2 <- "pa"
year <- 2016
yr     <- 16
defyr  <- 16
filename <- paste0(year,"1108__pa__GE__precinct.csv")
#END PARAMETERS
