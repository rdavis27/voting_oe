...
vrdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/bulk-election-data/2024-general-election/vr/vrstat2024_g_readme.txt"
vrdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/bulk-election-data/2024-general-election/vr/vrstat2024_g(9187)_20241223.txt"
erdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/resources/voting-and-elections/bulk-data/erstat_2024_g_readme.txt"
erdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/resources/voting-and-elections/bulk-data/erstat_2024_g_268768_20250129.txt"
state2 <- "pa"
year <- 2024
yr     <- 24
defyr  <- 24
filename <- paste0(year,"1105__pa__GE__precinct.csv")
#END PARAMETERS
