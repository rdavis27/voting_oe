...
url <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/resources/voting-and-elections/bulk-data/erstat_2024_g_268768_20250129.txt"
datapath <- "data/"
makepath <- "makedata/pa2024/"
makepath_pre <- paste0(makepath,"PA24_") #add file prefix
