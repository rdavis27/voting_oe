...
vrdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/VoterRegistration_2012_General_ReadMeFile.txt"
vrdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/VoterRegistration_2012_General_Precinct.xlsx"
erdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2012_General_ReadMeFile.txt"
erdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2012_General_PrecinctReturns.txt"
state2 <- "pa"
year <- 2012
yr     <- 12
defyr  <- 16
filename <- paste0(year,"1106__pa__GE__precinct.csv")
#END PARAMETERS
