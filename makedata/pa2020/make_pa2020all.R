...
vrdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/VoterRegistration_2020_General_ReadMeFile.txt"
vrdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/VoterRegistration_2020_General_Precinct.txt"
erdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2020_General_ReadMeFile.txt"
erdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2020_General_PrecinctReturns.txt"
state2 <- "pa"
year <- 2020
yr     <- 20
defyr  <- 24
filename <- paste0(year,"1103__pa__GE__precinct.csv")
#END PARAMETERS
