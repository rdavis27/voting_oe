...
#START PARAMETERS
#url accessible at https://www.pa.gov/agencies/dos/resources/voting-and-elections-resources/voting-and-election-statistics/bulk-election-data.html#accordion-b33bb36a11-item-8b942fe3d5
url <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2020_General_PrecinctReturns.txt"
datapath <- "data/"
makepath <- "makedata/pa2020/"
makepath_pre <- paste0(makepath,"PA20_") #add file prefix
filename <- "20201103__pa__GE__precinct.csv"
#END PARAMETERS

#Download 2020 PA Bulk Election Data
destpath <- paste0(makepath,basename(url))
download.file(url, destfile = destpath, mode = "wb")
#Read 2020 PA Bulk Election Data
dd <- read_csv(destpath, col_names = FALSE)
#Read 2020 PA Field, County Code, and Office Code definitions. These were created from file at
# https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2020_General_ReadMeFile.txt
# which is accessible at https://www.pa.gov/agencies/dos/resources/voting-and-elections-resources/voting-and-election-statistics/bulk-election-data.html#accordion-b33bb36a11-item-8b942fe3d5
