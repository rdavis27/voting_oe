...
vrdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/VoterRegistration_2004_General_Readme.txt"
vrdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/VoterRegistration_2004_General_precinct.txt"
erdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2004_General_ReadMe.txt"
erdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2004_General_Precinct.txt"
state2 <- "pa"
year <- 2004
yr     <- "04"
defyr  <- 16
filename <- paste0(year,"1102__pa__GE__precinct.csv")
#END PARAMETERS
