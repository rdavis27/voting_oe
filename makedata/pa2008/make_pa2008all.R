...
vrdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/VoterRegistration_2008_General_ReadMe.txt%20download="
vrdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/VoterRegistration_2008_General_Precinct.txt"
erdef  <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2008_General_ReadMe.txt"
erdata <- "https://www.pa.gov/content/dam/copapwp-pagov/en/dos/old-website-documents/ElectionReturns_2008_General_PrecinctReturns.txt"
state2 <- "pa"
year <- 2008
yr     <- "08"
defyr  <- 16
filename <- paste0(year,"1104__pa__GE__precinct.csv")
#END PARAMETERS
